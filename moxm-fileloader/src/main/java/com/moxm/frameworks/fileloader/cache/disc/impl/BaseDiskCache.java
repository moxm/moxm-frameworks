 ...
 *******************************************************************************/
package com.moxm.frameworks.fileloader.cache.disc.impl;
...
import com.moxm.frameworks.fileloader.cache.disc.naming.Md5FileNameGenerator;
...
public class BaseDiskCache implements DiskCache {
	...
	public boolean save(String fileUri, InputStream inputStream, IoUtils.CopyListener listener) throws IOException {
		...
		File tmpFile = new File(file.getAbsolutePath() + TEMP_FILE_POSTFIX);
	...
	protected File getFile(String fileUri) {
		String fileName = fileNameGenerator.generate(fileUri);
		File dir = cacheDir;
