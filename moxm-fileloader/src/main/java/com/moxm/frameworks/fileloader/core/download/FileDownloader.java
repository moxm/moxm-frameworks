...
/**
 * Provides retrieving of {@link InputStream} of file by URI.<br />
 * Implementations have to be thread-safe.
 *
 * @author richard.ma@msn.com
 * @since 1.4.0
 */
