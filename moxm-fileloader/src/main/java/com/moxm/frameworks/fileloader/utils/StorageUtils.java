 ...
 *******************************************************************************/
package com.moxm.frameworks.fileloader.utils;
...
public final class StorageUtils {
	...
	private static final String INDIVIDUAL_DIR_NAME = "one-file";
	...
	public static File getCacheDirectory(Context context, boolean preferExternal) {
		...
		if (appCacheDir == null) {
			...
			Log.w("StorageUtils", "Can't define system cache directory! '" + cacheDirPath + "' will be used.");
