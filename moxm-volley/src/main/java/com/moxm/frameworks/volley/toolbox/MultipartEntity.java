...
public class MultipartEntity implements HttpEntity {
     ...
     * by Richard
     */
    private static final String TYPE_TEXT_JSON = "application/json; charset=UTF-8";
     ...
     * by Richard
     */
    private static final String TYPE_TEXT_XML = "application/xml; charset=UTF-8";
    ...
    public void addBinaryPart(String key, final byte[] rawData) {
        addBinaryPart(key, rawData, "no-file");
    }
     ...
     * @param rawData
     */
    public void addBinaryPart(String key, final byte[] rawData, final String filename) {
        writeToOutputStream(key, rawData, TYPE_OCTET_STREAM, BINARY_ENCODING, filename);
    }
    ...
    private byte[] getContentDispositionBytes(String paramName, String fileName) {
        ...
        stringBuilder.append(CONTENT_DISPOSITION + "form-data");

        //文本参数没有name参数,设置为空即可
        if (!TextUtils.isEmpty(paramName)) {
            stringBuilder.append("; name=\"" + paramName + "\"");
        }
